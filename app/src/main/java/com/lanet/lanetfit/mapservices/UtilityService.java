...
package com.lanet.lanetfit.mapservices;
...
import com.lanet.lanetfit.Constants;
import com.lanet.lanetfit.Utils;
import com.lanet.lanetfit.provider.Attraction;
import com.lanet.lanetfit.provider.TouristAttractions;
...
public class UtilityService extends IntentService {
    ...
    public static final String ACTION_LOCATION_UPDATED1 = "location_updated";
    ...
    private void locationUpdated(Intent intent) {
        ...
        if (location != null) {
            ...
            Log.d(TAG, "locationUpdated() called with: " + "intent = [" + location.getAccuracy() + "]" + location.toString());
